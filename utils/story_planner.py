...
def build_segment_prompt(
    ...
    return (
        ...
        "-> Insight (1 sentence).\n"
        f"{char_desc_rule}\n"
        "CRITICAL: Use simple everyday words (grade-5 level) and short sentences. "
        "Make the narration highly emotional and dramatic! Use expressive punctuation like ellipses (...) for dramatic pauses, exclamation marks (!), and rhetorical questions (?). This forces the voice synthesizer to read it with intense emotion instead of sounding flat.\n"
