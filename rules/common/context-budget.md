...
| Component | Heuristic |
|-----------|-----------|
| Prose (CLAUDE.md, rules) | words × 1.3 |
...
- Skills > 400 lines
- Rules > 100 lines
- CLAUDE.md chains > 300 lines combined
...
| Bucket | Meaning |
|--------|---------|
| Always needed | Referenced in CLAUDE.md, active command backing |
...
| CLAUDE.md bloat | > 300 lines combined |
